 ...
 */
public class MyWishListRecyclerViewAdapter extends RecyclerView.Adapter<MyWishListRecyclerViewAdapter.ViewHolder> {

    private final List<HotelsClass> mValues;

    public MyWishListRecyclerViewAdapter(List<HotelsClass> items) {
        mValues = items;
    }
        ...
        public ViewHolder(View view) {
            ...
            hfavourite.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    HotelsClass hcur= (HotelsClass) MainActivity.FavouriteHotels.get(position);
                    hcur.setFavourite(!hcur.isFavourite());
                    MainActivity.FavouriteHotels.remove(position);
